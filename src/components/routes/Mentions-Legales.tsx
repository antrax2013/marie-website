			...
			<div>
				...
				<div>
					...
					<p>
						...
						utilisateurs du site massage-reiki.fr, massages-reiki.fr et
						marie.cophignon.net l’identité des différents intervenants dans le
						cadre de sa réalisation et de son suivi :
					</p>
					<ul>
						<li>Propriétaire : Marie COPHIGNON</li>
						<li>Créateur : Marie COPHIGNON</li>
						<li>Responsable publication : Marie COPHIGNON</li>
						<li>N° Siret : 910 427 988 00019</li>
						<li>
							Le responsable publication est une personne physique ou une
							personne morale
						</li>
						<li>Webmaster : Cyril COPHIGNON – cyril@cophignon.net</li>
				...
				<div>
					...
					<p>
						L’utilisation des sites massage-reiki.fr, massages-reiki.fr et
						marie.cophignon.net implique l’acceptation pleine et entière des
						...
						tout moment, les utilisateurs des sites massage-reiki.fr,
						massages-reiki.fr et marie.cophignon.net sont donc invités à les
					...
					<p>
						...
						toutefois décidée par Marie COPHIGNON, qui s’efforcera alors de
						communiquer préalablement aux utilisateurs les dates et heures de
						l’intervention.
					</p>
					<p>
						Les sites massage-reiki.fr, massages-reiki.fr et marie.cophignon.net
						sont mis à jour régulièrement par Marie COPHIGNON. De la même façon,
				...
				<div>
					...
					<p>
						Les sites massage-reiki.fr, massages-reiki.fr et marie.cophignon.net
						ont pour objet de fournir une information concernant l’ensemble des
						activités de la société : Marie COPHIGNON - Thérapeute énergétique
						n°910 427 988 00019.
					</p>
					<p>
						Marie COPHIGNON s’efforce de fournir sur les sites massage-reiki.fr,
						massages-reiki.fr et marie.cophignon.net des informations aussi
					...
					<p>
						Toutes les informations indiquées sur les sites massage-reiki.fr,
						massages-reiki.fr et marie.cophignon.net sont données à titre
						indicatif, et sont susceptibles d’évoluer. Par ailleurs, les
						renseignements figurant sur les sites massage-reiki.fr,
						massages-reiki.fr et marie.cophignon.net ne sont pas exhaustifs. Ils
				...
				<div>
					...
					<p>
						Les sites Internet massage-reiki.fr, massages-reiki.fr et
						marie.cophignon.net ne pourront être tenus responsable de dommages
				...
				<div>
					...
					<p>
						Marie COPHIGNON est propriétaire des droits de propriété
					...
					<p>
						...
						préalable de Marie COPHIGNON.
					</p>
					<p>
						Toute exploitation non autorisée des sites, massage-reiki.fr,
						massages-reiki.fr et marie.cophignon.net ou de l’un quelconque des
						éléments qu’ils contiennent, sera considérée comme constitutive
				...
				<div>
					...
					<p>
						Marie COPHIGNON ne pourra être tenue responsable des dommages
						directs et indirects causés au matériel de l’utilisateur, lors de
						l’accès aux sites massage-reiki.fr, massages-reiki.fr et
						marie.cophignon.net, et résultant soit de l’utilisation d’un
						matériel ne répondant pas aux spécifications indiquées au point 4,
						soit de l’apparition d’un bug ou d’une incompatibilité.
					</p>
					<p>
						Marie COPHIGNON ne pourra également être tenue responsable des
						dommages indirects (tels par exemple qu’une perte de marché ou perte
						d’une chance) consécutifs à l’utilisation des sites
						massage-reiki.fr, massages-reiki.fr et marie.cophignon.net.
					</p>
					<p>
						Des espaces interactifs (possibilité de poser des questions dans
						l’espace contact) sont à la disposition des utilisateurs. Marie
						COPHIGNON se réserve le droit de supprimer, sans mise en demeure
						...
						relatives à la protection des données. Le cas échéant, Marie
						COPHIGNON se réserve également la possibilité de mettre en cause la
				...
				<div>
					...
					<p>
						A l’occasion de l’utilisation des sites massage-reiki.fr,
						massages-reiki.fr et marie.cophignon.net, peuvent êtres recueillies
						: l’URL des liens par l’intermédiaire desquels l’utilisateur a
						accédé au site massage-reiki.fr, massages-reiki.fr et
						marie.cophignon.net, le fournisseur d’accès de l’utilisateur,
						l’adresse de protocole Internet (IP) de l’utilisateur.
					</p>
					<p>
						En tout état de cause Marie COPHIGNON ne collecte des informations
						personnelles relatives à l’utilisateur que pour le besoin de
						certains services proposés par les sites massage-reiki.fr,
						massages-reiki.fr et marie.cophignon.netN. L’utilisateur fournit ces
						informations en toute connaissance de cause, notamment lorsqu’il
						procède par lui-même à leur saisie. Il est alors précisé à
						l’utilisateur des sites massage-reiki.fr, massages-reiki.fr et
						marie.cophignon.net l’obligation ou non de fournir ces informations.
					</p>
					<p>
					...
					<p>
						Aucune information personnelle de l’utilisateur des sites
						massage-reiki.fr, massages-reiki.fr et marie.cophignon.net n’est
						...
						rachat de Marie COPHIGNON et de ses droits permettrait la
						...
						modification des données vis à vis de l’utilisateur des sites
						massage-reiki.fr, massages-reiki.fr et marie.cophignon.net.
					</p>
					<p>
				...
				<div>
					...
					<p>
						Les sites massage-reiki.fr, massages-reiki.fr et marie.cophignon.net
						contiennent un certain nombre de liens hypertextes vers d’autres
						sites, mis en place avec l’autorisation de Marie COPHIGNON.
						Cependant, Marie COPHIGNON n’a pas la possibilité de vérifier le
						contenu des sites ainsi visités, et n’assumera en conséquence aucune
						responsabilité de ce fait.
					</p>
					<p>
						La navigation sur les sites massage-reiki.fr, massages-reiki.fr et
						marie.cophignon.net est susceptible de provoquer l’installation de
				...
				<div>
					...
					<p>
						Tout litige en relation avec l’utilisation des sites
						massage-reiki.fr, massages-reiki.fr et marie.cophignon.net est
				...
				<div>
					<h2>Lexique</h2>
					<p>
						Utilisateur : Internaute se connectant, utilisant les sites
						susnommés.
					</p>
					<p>
