const PolitiqueConfidentialite = () => {
  return (
    <article>
      ...
      <h2>
        Avis important concernant le traitement des données en lien avec Google
        Analytics
      </h2>
      <p>
        ...
        États-Unis). Google Ireland Limited et Google LLC sont dénommés ci-après
        « Google ».
      </p>
      <p>
        ...
        l’utilisation du site web sont généralement transmises à et stockées par
        Google.
      </p>
      <p>
        Google Analytics est utilisé exclusivement avec l'extension «
        _anonymizeIp () » sur ce site. L’extension garantit une anonymisation de
        l’adresse IP par troncature et exclut de ce fait toute référence
        personnelle directe. Via cette extension, Google tronque l’adresse IP du
        visiteur du site situé dans un État membre de l’Union européenne ou dans
        un autre État parti à l’accord sur l’Espace économique européen.
        L’adresse IP complète du visiteur du site ne sera transmise aux serveurs
        de Google et tronquée aux Etats-Unis que dans des situations
      ...
      <p>
        ...
        collectées pour évaluer l’utilisation du site, compiler des rapports sur
        l’activité du site et fournir d’autres services liés au site web et à
        internet à l’opérateur du site (art. 6, 1. f, RGPD). L’intérêt légitime
        dans le traitement des données se trouve dans l'optimisation de ce site,
        l’analyse de l’utilisation du site et l'adaptation du contenu. L’intérêt
        des utilisateurs est adéquatement protégé par la pseudonymisation de
        leurs données.
      </p>
      <p>
        ...
        et couplées aux cookies de Google Analytics, comme l'ID de l’utilisateur
        ou les ID publicitaires, seront automatiquement effacés après 50 mois.
        La suppression des données qui ont atteint la date limite de
        conservation est effectuée automatiquement une fois par mois.
      </p>
      <p>
