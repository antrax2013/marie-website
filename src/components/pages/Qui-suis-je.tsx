  ...
  return (
    <>
      ...
      <article>
        <h1>Qui suis-je ?</h1>
        <p>
          Infirmière par vocation depuis 17 ans, mon métier de cœur, j’ai pris
          la décision de prendre soin des autres différement. Prendre soin des
        ...
        <p>
          ...
          essentielles. Puis j'ai rencontré de belles personnes qui m'ont
          permises de découvrir les soins energétiques. Elles m'ont donné
          l'envie, il y a deux ans de me former au{' '}
          <a href='/reiki'>
            <em>Reiki</em>
          </a>{' '}
        </p>
        ...
        <p>
          ...
          m'est apparu comme une évidence. Il Combine à la fois l'utilisation
          des huiles essentielles, du Reiki et différentes techniques de
          massages.
        </p>
        <p>
