    ...
    <div className='Reiki'>
      <article>
        ...
        <section className='paragraphe-4'>
          <section className='paragraphe-content'>
            <p>
              Une séance type de <em>Reiki</em> dure environ 1h00 et se déroule
              en 3 temps :
            </p>
            <ul>
              <li>
              ...
              <li>
                ...
                votre bien être. Laissez-vous aller, lachez prise. Profitez de
                cet instant de douceur et de calme, l'énergie du <em>Reiki</em>{' '}
                se diffuse là où vous en avez besoin.
              </li>
              <li>
