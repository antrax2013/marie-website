    ...
    <article>
      ...
      <section className='paragraphe-1'>
        <section className='paragraphe-content'>
          <p>
            Le <em>Massage Des 5 Continents</em> est une technique, qui combine
            différentes méthodes de massages, un soin energétique et des huiles
            végétales et des huiles essentielles. Cette association fait du{' '}
            <em>Massage Des 5 Continents</em> un massage unique, puissant
            permettant un lâcher prise physique et mental.
          </p>
        </section>
      </section>
      ...
      <section className='paragraphe-2'>
        <section className='paragraphe-content'>
          <p>
            ...
            votre ventre, vos bras et vos jambes. Si pour des raisons médicales,
            certaines zones sont contre-indiquées, j'adapterais le massage en
            conséquence.
          </p>
          <p>
          ...
          <p>
            En raison de la présence des huiles essentielles, il est recommandé
            de n'utiliser que des huiles végétales pour :{' '}
            <ul>
          ...
          <p>
            <i>
              ...
              <em>Massage Des 5 Continents</em>. Il est également préférable de
              manger léger avant un <em>Massage Des 5 Continents</em>, de
      ...
      <section className='paragraphe-3'>
        ...
        <section className='paragraphe-content'>
          ...
          <p>
            Le <em>Massage des 5 Continents</em> est un massage biodynamique. Il
            reveille les processus naturels d'auto-guérison. Il permet de se
            décharger des toxines et des mémoires émotionnelles, laissant place
            à des energies de plaisir et de vie. Le{' '}
      ...
      <section className='paragraphe-4'>
        <section className='paragraphe-content'>
          <p>
            Le <em>Massage des 5 Continents</em> dure environ 1h15 et se déroule
            en 3 temps :
          </p>
          <ul>
            <li>
            ...
            <li>
              ...
              du dos et des jambes. A l'aide d'un complexe d'huiles, de massages
              doux, je stimule votre organisme dans le but de lâcher prise,
              revitaliser et stimuler votre système immunitaire. Cette première
              partie du <em>Massage des 5 Continents</em>, s'achève sur un soin
              energétique. Le Reiki permet de faire circuler l'énergie vitale
              directement à l'intérieur de votre corps, là où vous en avez
              besoin. Pour la seconde partie du massage, je vais masser voter
              ventre, vos bras et vos jambes. L'enchainement du massage est
              identique à la première partie: une phase détoxifiante, une phase
              relaxante et un soin Reiki.
            </li>
            <li>
          ...
          <p>
            ...
            pas anodine. Elles ne sont pas recommandées à tout le monde. Afin de
            sastisfaire une plus grand nombre, il est possible de n'utiliser que
            des huiles végetales. Je m'adapte à vos contres indications.
          </p>
        </section>
        <aside>
          <div>
